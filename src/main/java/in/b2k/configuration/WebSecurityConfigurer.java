...
import in.b2k.security.config.NoRedirectStrategy;
import in.b2k.security.config.TokenAuthenticationFilter;
import in.b2k.security.config.TokenAuthenticationProvider;
...
public class    WebSecurityConfigurer extends WebSecurityConfigurerAdapter {
    ...
    private static final RequestMatcher PUBLIC_URLS = new OrRequestMatcher(
            ...
            new AntPathRequestMatcher("/public/users/register"),
    ...
    WebSecurityConfigurer(final TokenAuthenticationProvider provider) {
        super();
